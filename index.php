...
if(isset($_POST["register"]))
{
 ...
 if($error_user_name == '' && $error_user_email == '' && $error_user_password == '')
 {
  ...
  else
  {
   ...
   $mail->WordWrap = 50;
   $mail->IsHTML(true);
   $mail->Subject = 'OTP to Verify Your Email Address';

   $message_body = '
   <p>To verify your email address and submit data, please enter this verification code when prompted: <b>'.$user_otp.'</b>.</p>
   <p>Sincerely,</p>
   <p>Rahul Bhandari</p>
   ';
    ...
    <div class="panel-body">
     ...
     <form method="post">
      ...
      <div class="form-group">
       ...
       <a href="resend_email_otp.php" class="btn blue">Resend OTP</a>
       &nbsp;&nbsp;&nbsp;
